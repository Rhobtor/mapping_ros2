...
// // // base
// // em::layers::addSlope     (map_.getRawGridMap(), cell);
// // em::layers::addRoughness (map_.getRawGridMap(), layers_.rough_window_m);
// // em::layers::addStep      (map_.getRawGridMap(), layers_.step_window_m);

// // // obstáculo binario geométrico (pendiente + escalón)
// // em::layers::addObstacleBinaryFromGeom(map_.getRawGridMap(),
// //                                       /*slope_thresh_rad=*/layers_.slope_long_max_rad,
// //                                       /*step_thresh_m=*/layers_.step_max_m);

// // // traversabilidad y riesgo (opcional)
// // em::layers::addTraversabilityFromSlopeRough(map_.getRawGridMap(),
// //                                             layers_.trav_slope_max_rad,
// //                                             layers_.trav_rough_max_m,
// //                                             layers_.trav_w_slope,
// //                                             layers_.trav_w_rough);

// // em::layers::addCvarTraversability(map_.getRawGridMap(),
// //                                   layers_.cvar_alpha,
// //                                   layers_.cvar_window_m);

// // // negativos (opcional)
// // em::layers::addNegativeObstacles(map_.getRawGridMap(),
// //                                  /*drop_thresh_m=*/0.20,
// //                                  /*ring_m=*/0.20);

// // // (opcional) OccupancyGrid — en Humble devuelve VOID
// // if (obstaclesGridPub_ && obstaclesGridPub_->get_subscription_count() > 0) {
// //   nav_msgs::msg::OccupancyGrid og;
// //   grid_map::GridMapRosConverter::toOccupancyGrid(
// //       map_.getRawGridMap(), "obstacles", 0.0f, 1.0f, og);
// //   og.header.stamp = nodeHandle_->get_clock()->now();
// //   og.header.frame_id = map_.getFrameId();
// //   obstaclesGridPub_->publish(og);
// // }
// // ====== CAPAS LIGERAS + PESADAS (decimación) ======
// frameCount_++;
...
// // Obstáculo binario geométrico (pendiente + escalón) — cada nube
...
//   }
//   if (enable_.cvar) {
//     // Asegúrate de que tu addCvarTraversability escriba en "cvar_risk"
//     em::layers::addCvarTraversability(
//         map_.getRawGridMap(),
//         /*alpha=*/  layers_.cvar_alpha,
//         /*win_m=*/  layers_.cvar_window_m /*, out="cvar_risk" */);
//   }
// }
...
// // (opcional) publicar OccupancyGrid de la capa final
// if (obstaclesGridPub_ && obstaclesGridPub_->get_subscription_count() > 0) {
//   nav_msgs::msg::OccupancyGrid og;
//   grid_map::GridMapRosConverter::toOccupancyGrid(
...
// //     return;
// //   }
// // tatic int tickCount_ = 0;
// // tickCount_++;

// // const double cell = map_.getRawGridMap().getResolution();

// // // Capas base (baratas): siempre
// // if (enable_.slope) em::layers::addSlope     (map_.getRawGridMap(), cell);
// // if (enable_.rough) em::layers::addRoughness (map_.getRawGridMap(), layers_.rough_window_m);
// // if (enable_.step)  em::layers::addStep      (map_.getRawGridMap(), layers_.step_window_m);

// // // Obstáculo binario geométrico (pendiente + escalón): siempre
// // if (enable_.obstacles_binary) {
// //   em::layers::addObstacleBinaryFromGeom(
// //       map_.getRawGridMap(),
// //       /*slope_thresh_rad=*/layers_.slope_long_max_rad,
...
// // // Capas pesadas (negative, CVaR): cada N “ticks” del timer
// // if (tickCount_ % std::max(1, rates_.heavy_every_n) == 0) {
// //   if (enable_.negative) {
// //     em::layers::addNegativeObstacles(
// //         map_.getRawGridMap(),
// //         /*drop_thresh_m=*/ rates_.neg_drop_thresh_m,
// //         /*ring_m=*/        rates_.neg_ring_m,
// //         /*min_valid=*/     rates_.neg_min_valid_ratio,
...
// //   }
// //   if (enable_.cvar) {
// //     // Asegúrate de que tu función escriba en "cvar_risk" (o cambia abajo).
// //     em::layers::addCvarTraversability(
// //         map_.getRawGridMap(),
// //         /*alpha=*/ layers_.cvar_alpha,
// //         /*win_m=*/ layers_.cvar_window_m /*, out="cvar_risk" */);
...
// // // Capa final para el planificador
// // em::layers::combineToFinalObstacles(
// //     map_.getRawGridMap(),
// //     /*obstacles_layer=*/ "obstacles",
// //     /*negatives_layer=*/ "negatives",
...
// // // (opcional) publicar OccupancyGrid de la final
// // if (obstaclesGridPub_ && obstaclesGridPub_->get_subscription_count() > 0) {
// //   nav_msgs::msg::OccupancyGrid og;
// //   grid_map::GridMapRosConverter::toOccupancyGrid(
// //       map_.getRawGridMap(), "obstacles_final", 0.0f, 1.0f, og);
...
// // // Publicación normal del mapa
// // map_.postprocessAndPublishRawElevationMap();
// // if (isFusingEnabled()) { map_.fuseAll(); map_.publishFusedElevationMap(); }
// //   // Publish elevation map.
// //   map_.postprocessAndPublishRawElevationMap();
// //   if (isFusingEnabled()) {
// //     map_.fuseAll();
...
//   static int tickCount_ = 0;   // <-- aquí estaba el typo
//   tickCount_++;
