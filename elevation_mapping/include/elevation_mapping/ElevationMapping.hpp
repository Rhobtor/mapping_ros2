...
class ElevationMapping {
  private:
    ...
    struct LayerConfig {
      ...
      double clearance_nominal_m  = 0.05;

      // (opcional) trav + riesgo
      double trav_slope_max_rad = 0.60;
      double trav_rough_max_m   = 0.10;
      double trav_w_slope       = 0.5;
  ...
  struct RatesConfig {
    ...
    double cvar_tau     = 0.70; // umbral riesgo
    // Negative params
    double neg_min_valid_ratio = 0.30;
    double neg_slope_gate_rad  = 0.25;
